...
\begin{cventries}
  ...
  \cventry
    ...
    {
      \begin{cvitems}
        \item{Building / managing resources in Azure with Terraform}
        \item{Setting up Azure CI/CD pipelines}
        \item{Deploying / maintaining k8s resources with HELM}
      \end{cvitems}
    }
...
\begin{cventries}
  ...
  \cventry
    {Creator}
    {Maintaining -Azure Kubernetes Service- cluster (Offline)}
    {wikitest.parkhost.eu}
    {Terraform / ArgoCD / Azure DevOps / kubernetes}
